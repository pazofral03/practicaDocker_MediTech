...
class Usuario(UserMixin, db.Model):
    ...
    citas_como_medico = db.relationship('Cita', foreign_keys='Cita.medico_id', backref='medico', lazy=True, cascade="all, delete-orphan")
    citas_como_paciente = db.relationship('Cita', foreign_keys='Cita.paciente_id', backref='paciente', lazy=True, cascade="all, delete-orphan")
    
    # Relacion de ausencias (médico)
    ausencias = db.relationship('Ausencia', backref='medico', lazy=True, cascade="all, delete-orphan")
